...
from my_sampler3 import CugraphEGOSampler
import rmm
import sys
import cugraph
import cudf
...
def main(args):
    ...
    if args.sampler == "node":
        ...
        subg_iter = CugraphEGOSampler(args.num_roots, args.length, args.dataset, g, g_cugraph_train,
                                    train_nid, args.num_repeat)
...
if __name__ == '__main__':
    ...
    # sampler params
    parser.add_argument("--sampler", type=str, default="node", choices=['node', 'edge', 'rw', 'cugraph_ego'],
